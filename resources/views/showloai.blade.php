...
<div class="container">
    <div class="row">
        <div class="col-9 detail">
            <div> 
                <p style="font-weight: 500;"><span>Tên loại món:</span> {{$loai['TenLoai']}}</p>
            </div>
           <div>
                <p><span>Trạng thái:</span> {{$loai['TrangThai']}}</p><br>
           </div>
        </div>
    </div>
</div>
<div><button class="btn btn-primary"><a href="{{route('loai.index')}}">Trở về</a></button></div>
@stop