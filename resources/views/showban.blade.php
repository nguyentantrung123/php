...
<div class="container">
    <div class="row">
        <div class="col-9 detail">
            <div> 
                <p style="font-weight: 500;"><span>Tên bàn:</span> {{$ban['TenBan']}}</p>
            </div>
            <div>
                <p style="margin-top:10px"><span>Vị trí:</span> {{$ban['ViTri']}}</p><br>
            </div>
           
           <div>
                <p><span>Số người:</span>{{$ban['SoNguoi']}}</p><br>
           </div>
           <div>
                <p><span>Số ghế:</span> {{$ban['SoGhe']}}</p><br>
           </div>
           <div>
                <p><span>Trạng thái:</span> {{$ban['TrangThai']}}</p><br>
           </div>
        </div>
    </div>
</div>
<div><button class="btn btn-primary"><a href="{{route('ban.index')}}">Trở về</a></button></div>
