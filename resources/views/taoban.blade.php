...
<form action="{{route('ban.store')}}" enctype="multipart/form-data" method="POST">
    @csrf
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="vitri" name="vitri" value="">
  </div>
  ...
  <button type="submit" class="btn btn-primary" onclick="them()">thêm</button>
</form>
